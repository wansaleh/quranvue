...
QuranData.Sura = [
	...
	[293, 200, 89, 20, 'آل عمران', "Ali-Imran", 'The Family of Imraan', 'Medinan'],
	[493, 176, 92, 24, 'النساء', "An-Nisa", 'The Women', 'Medinan'],
	[669, 120, 112, 16, 'المائدة', "Al-Maidah", 'The Table', 'Medinan'],
	[789, 165, 55, 20, 'الأنعام', "Al-An'aam", 'The Cattle', 'Meccan'],
	[954, 206, 39, 24, 'الأعراف', "Al-Aa'raf", 'The Heights', 'Meccan'],
	[1160, 75, 88, 10, 'الأنفال', "Al-Anfal", 'The Spoils of War', 'Medinan'],
	[1235, 129, 113, 16, 'التوبة', "At-Taubah", 'The Repentance', 'Medinan'],
	...
	[2140, 110, 69, 12, 'الكهف', "Al-Kahfi", 'The Cave', 'Meccan'],
	...
	[3503, 30, 75, 3, 'السجدة', "As-Sajdah", 'The Prostration', 'Meccan'],
	...
	[3705, 83, 41, 5, 'يس', "Yasin", 'Yaseen', 'Meccan'],
	[3788, 182, 56, 5, 'الصافات', "As-Saffaat", 'Those drawn up in Ranks', 'Meccan'],
	[3970, 88, 38, 5, 'ص', "Saad", 'The letter Saad', 'Meccan'],
	[4058, 75, 59, 8, 'الزمر', "Az-Zumar", 'The Groups', 'Meccan'],
	[4133, 85, 60, 9, 'غافر', "Al-Ghafir", 'The Forgiver', 'Meccan'],
	...
	[4473, 37, 65, 4, 'الجاثية', "Al-Jathiyah", 'Crouching', 'Meccan'],
	...
	[4675, 60, 67, 3, 'الذاريات', "Adh-Dzariyat", 'The Winnowing Winds', 'Meccan'],
	...
	[4979, 96, 46, 3, 'الواقعة', "Al-Waqiah", 'The Inevitable', 'Meccan'],
	[5075, 29, 94, 4, 'الحديد', "Al-Hadid", 'The Iron', 'Medinan'],
	[5104, 22, 105, 3, 'المجادلة', "Al-Mujadilah", 'The Pleading Woman', 'Medinan'],
	[5126, 24, 101, 3, 'الحشر', "Al-Hashr", 'The Exile', 'Medinan'],
	[5150, 13, 91, 2, 'الممتحنة', "Al-Mumtahanah", 'She that is to be examined', 'Medinan'],
	[5163, 14, 109, 2, 'الصف', "As-Saff", 'The Ranks', 'Medinan'],
	[5177, 11, 110, 2, 'الجمعة', "Al-Jumu'ah", 'Friday', 'Medinan'],
	...
	[5447, 28, 40, 2, 'الجن', "Al-Jin", 'The Jinn', 'Meccan'],
	[5475, 20, 3, 2, 'المزمل', "Al-Muzzammil", 'The Enshrouded One', 'Meccan'],
	[5495, 56, 4, 2, 'المدثر', "Al-Muddaththir", 'The Cloaked One', 'Meccan'],
	[5551, 40, 31, 2, 'القيامة', "Al-Qiyamah", 'The Resurrection', 'Meccan'],
	[5591, 31, 98, 2, 'الانسان', "Al-Insan", 'Man', 'Medinan'],
	...
	[5967, 26, 68, 1, 'الغاشية', "Al-Ghashiyah", 'The Overwhelming', 'Meccan'],
	...
	[6130, 8, 100, 1, 'البينة', "Al-Bayyinah", 'The Evidence', 'Medinan'],
	[6138, 8, 93, 1, 'الزلزلة', "Az-Zalzalah", 'The Earthquake', 'Medinan'],
	[6146, 11, 14, 1, 'العاديات', "Al-Aadiyat", 'The Chargers', 'Meccan'],
	[6157, 11, 30, 1, 'القارعة', "Al-Qari'ah", 'The Calamity', 'Meccan'],
	[6168, 8, 16, 1, 'التكاثر', "At-Takathur", 'Competition', 'Meccan'],
	[6176, 3, 13, 1, 'العصر', "Al-Asr", 'The Declining Day, Epoch', 'Meccan'],
	[6179, 9, 32, 1, 'الهمزة', "Al-Humazah", 'The Traducer', 'Meccan'],
	...
	[6221, 4, 22, 1, 'الإخلاص', "Al-Ikhlas", 'Sincerity', 'Meccan'],
